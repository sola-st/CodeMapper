...
class MeasureHistoriesLineLevel():
    def __init__(self, oracle_file_folder, results_dir, results_csv_file):
        ...
        # self.expected_commits = ["Expected commits"]
    ...
    def run(self):
        ...
        results_num = len(subfolders)
        for num in range(results_num):
...
if __name__=="__main__":
    ...
    MeasureHistoriesLineLevel(oracle_file_folder, results_dir, results_csv_file).run()