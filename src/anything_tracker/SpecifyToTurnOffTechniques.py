class SpecifyToTurnOffTechniques():
    ...
    def __init__(self, turn_off_techniques:list):
        ...
        self.turn_off_move_detection = turn_off_techniques[0]
        self.turn_off_search_matches = turn_off_techniques[1]
        self.turn_off_fine_grains = turn_off_techniques[2]

    def get_all(self):
        return self.turn_off_move_detection, self.turn_off_search_matches, self.turn_off_fine_grains