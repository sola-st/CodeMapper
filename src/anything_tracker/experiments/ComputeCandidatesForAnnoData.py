...
if __name__ == "__main__":
    ...
    result_dir_parent = join("data", "results", "tracked_maps", "UI_candidate_regions")
    oracle_file = join("data", "annotation", "anno5_test.json") # annotated_maps
    # is_reversed_data = False
    ComputeCandidatesForAnnoData(oracle_file, result_dir_parent).run()